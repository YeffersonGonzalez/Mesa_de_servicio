  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row d-print-none"><!-- fila contenedora -->
        <div class="col-md-12"> <!-- fin columna de contenido -->
        <form name="frm_filtro" id="frm_filtro" method="GET" action="productos_informes2.php" >
            <div class="card">
              ...
              <div class="card-body">
                ...
                <input type="text" id="userId" name="userId" class="form-control"><br> 
                  ...
                  <button type="submit" class="btn btn-success" id="buscar" value="Buscar">BUSCAR</button><br>
                  <button type="submit" class="btn btn-info" id="Vtodo" >Ver Todo</button>
        ...
        <div class="col-md-12"><!--  -->
          ...
          <div class="card">
              ...
              document.getElementById('buscar').addEventListener('click', function(event) {
                ...
                obtenerDatos(userId).then(mostrarDatos);
              });

              document.getElementById('Vtodo').addEventListener('click', function(event) {
                event.preventDefault(); 
                obtenerDatos().then(mostrarDatos);
              });

              function obtenerDatos(userId) {
               let url = 'http://localhost/web_electiva_II_BASE/api/usuarioGet.php';
                 if (userId) {
                  url += `?id=${userId}`;
                   }
                  return fetch(url)
              ...
              function mostrarDatos(data) {
               ...
               return fetch(`http://localhost/web_electiva_II_BASE/api/usuarioGet.php`)
                 ...
                 datosUl.innerHTML = ''; // Limpiar el contenido anterior
                  ...
                  <table  class=" table  ">
                      <tbody>
                        ...
                        <td style="width: 20%">${usuario.user}</td>
                         ...
                         <td style="width: 10%">
                         <a href="http://localhost/web_electiva_II_BASE/api/usuarioGet.php?id=${usuario.id}" class="bnt btn-xs btn-info"><i class="fas fa-eye"></i></a>
                          </td>
                           </tr>    
                         </tbody>
                        </table> 
                      `);
                 datosUl.appendChild(fragmentoUsuario);
                 });
               }
              }
