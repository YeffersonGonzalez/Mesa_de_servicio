...
<!-- COLUMNA DE FORMULARIO  -->
        <div class="col-md-6"><!-- columna de contenido -->
            ...
            if(isset($_POST["txt_refer"])){//verificar la existencia de envio de datos
              ...
              $ejecucion = $objDBO->Operaciones("INSERT INTO empleados(cedula, nombre, direccion, telefono) 
                                                                values('$refer','$nombr', '$canti', '$vlrcm' )  ");
                ...
                <div class="row">
                  ...
                  <div class="col-md-12 col-sm-12 col-12">
                    <div class="form-group">
                      <label for="txt_refer">Cedula</label>
                      <input type="text" class="form-control" id="txt_refer" name="txt_refer" placeholder="Cedula">
                    </div> 
                  </div>  
                 ...
                 <!-- Control cantidad  -->
                  <div class="col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                      <label for="txt_cantEx">Direccion</label>
                      <input type="text" class="form-control" id="txt_cantEx" name="txt_cantEx" placeholder="Direccion">
                    </div> 
                  </div> 
                  ...
                  <div class="col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                      <label for="txt_vlrCom">Telefono</label>
                      <input type="text" class="form-control" id="txt_vlrCom" name="txt_vlrCom" placeholder="Telefono">
                    </div> 
                  </div> 
