        ...
        <div class="col-md-6"><!-- columna de contenido -->
            ...
            if(isset($_POST["txt_cc"])){//verificar la existencia de envio de datos
              ...
              $ejecucion = $objDBO->Operaciones("INSERT INTO cliente(cedula, nombre, direccion, telefono) 
                                                                values('$cedula','$nombr', '$direc', '$tele' )  ");
                ...
                <div class="row">
                  ...
                  <div class="col-md-12 col-sm-12 col-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="txt_cc" name="txt_cc" placeholder="Cedula">
                    </div> 
                  </div>  
                 ...
                 <!-- Control cantidad  -->
                  ...
                  <div class="col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="txt_Tele" name="txt_Tele" placeholder="Telefono">
                    </div> 
                  </div> 
