...
<!-- COLUMNA DE FORMULARIO  -->
        <div class="col-md-6"><!-- columna de contenido -->
            ...
            <form role="form" name="frm_prods" id="frm_prods" method="POST" action="productos_crear_Luis.php" enctype="multipart/form-data">
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                      <label for="txt_cantEx">Nombre</label>
                  ...
                  <div class="col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                      <label for="txt_vlrCom">Cedula</label>
                      <input type="number" class="form-control" id="txt_vlrCom" name="txt_vlrCom" placeholder="Cedula">
                    </div> 
                  </div>
              ...
              <div class="card-footer">
                <button type="submit" id="btn_regist" class="btn btn-success">Registrar </button>
